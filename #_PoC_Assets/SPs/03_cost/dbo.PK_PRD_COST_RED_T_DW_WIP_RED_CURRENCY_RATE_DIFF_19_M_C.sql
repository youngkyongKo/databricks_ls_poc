CREATE PROC [dbo].[PK_PRD_COST_RED_T_DW_WIP_RED_CURRENCY_RATE_DIFF_19_M_C] @F_YYYYMM [varchar](50),@T_YYYYMM [varchar](50) AS
BEGIN
    ...
    BEGIN
        ...
        SET @v_run_pgm = 'PK_PRD_COST_RED_T_DW_WIP_RED_CURRENCY_RATE_DIFF_19_M_C' -- procedure name 
        ;
        ...
        BEGIN TRY
                ...
                DELETE FROM [dbo].[T_DW_WIP_RED_CURRENCY_RATE_DIFF] 
                 WHERE BASE_YYYYMM = @v_parm_to         --파라미타
                ;  

                INSERT INTO [dbo].[T_DW_WIP_RED_CURRENCY_RATE_DIFF]
                (      [BASE_YYYYMM]
                     , [ORGANIZATION_ID]
                     , [ORG_CODE]
                     , [ITEM_ID]
                ...
                SELECT YYYYMM
                     ...
                     , A.RECEIPT_QTY
                     , A.CURRENCY_CODE
                     , ROUND(A.PLAN_CURRENCY_RATE,4)    AS PLAN_CURRENCY_RATE
                     , ROUND(A.RECEIPT_CURRENCY_RATE,4) AS RECEIPT_CURRENCY_RATE
                     , DATEADD(HOUR, 9 ,GETDATE())  AS ETL_DT
                  FROM ERPSYS.ERP_EBOM_CURRENCY_RATE_DIFF A
            ...
            SELECT @v_load_cnt = COUNT(1)
              FROM [dbo].[T_DW_WIP_RED_CURRENCY_RATE_DIFF]
